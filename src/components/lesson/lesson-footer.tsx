...
export function LessonFooter({
  ...
  return (
    <footer className={cn(
      ...
      status === 'CORRECT' && "bg-[#D7FFB8] border-transparent",
          ...
          {status === 'IDLE' ? (
             <button
                ...
                className={cn(
                   ...
                   isDisabled 
                      ...
                      : "bg-[#58CC02] text-white hover:bg-[#61E002] shadow-[0_5px_0_0_#46A302] active:shadow-none active:translate-y-1"
                )}
             >
            ...
            <button
               ...
               className={cn(
                ...
                status === 'CORRECT' ? "bg-[#58CC02] shadow-[0_5px_0_0_#46A302]" : "bg-[#FF4B4B] shadow-[0_5px_0_0_#EA2B2B]"
              )}
            >
              Continue
            </button>
